...
<template>
    ...
    >
        <div class="flex items-center gap-2">
            ...
            <div v-if="breadcrumbs.length > 0" class="hidden md:flex items-center">
                <Breadcrumb>
                    <BreadcrumbList>
        ...
        <Link :href="route('admin.dashboard')" class="absolute left-1/2 -translate-x-1/2 flex items-center gap-1 md:hidden">
            <AppLogo />
        </Link>
    </header>
</template>
